...
import utils.Genesis2._
import utils.TypeClasses._

final class GenesisApiSpec2 extends WordSpec with Matchers with PropertyChecks {
  ...
  "A genetic algorithm" should {
    ...
    "apply a genesis function with possibility of early exit" in {
      ...
      val vec = Genesis2.lift[(Int, Int), Nothing, Int](Vector(1, 2, 3, 4) map ((_, 0)))
    ...
    "apply a global accumulation function" in {
      ...
      val data = Genesis2.lift[Int, Nothing, Int](Vector(1, 2, 3, 4))
      ...
      Genesis2.attempt[Int, Nothing, Int, Gen[Int, Nothing, Int]](data, 4)((a, _) => a)(addOne)
    ...
    "variate between mutation typeclasses based on some predicate" in {
      ...
      val vec = Genesis2.lift[Int, Nothing, Int]((0 to 50).toVector)

      val rep1 = Genesis2.replicateWith[Int, Nothing, Int](10)(_.size % 2 == 0)(monInt, (mut1, mut2), (cross1, cross2))((vec, l1))
      val rep2 = Genesis2.replicateWith[Int, Nothing, Int](10)(_.size % 2 == 0)(monInt, (mut1, mut2), (cross1, cross2))((vec, l2))
