...
final class GenesisApiSpec extends WordSpec with Matchers with PropertyChecks {
  ...
  "A genetic algorithm" should {
    ...
    "apply a global accumulation function" in {
      ...
      implicit val eval: Eval[Int, Nothing, Int] = Eval.instance[Int, Nothing, Int](withValue)
