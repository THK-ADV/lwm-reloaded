...
import models.labwork.{AssignmentEntry, AssignmentEntryType, AssignmentPlan, Labwork}
...
class AssignmentPlanInvalidation extends SesameDbSpec {
  ...
  "An AssignmentPlan invalidation" should {
    ...
    def aplans: Stream[AssignmentPlan] = Stream.continually(AssignmentPlan(Labwork.randomUUID, 1, 2, (aentry take 10).toSet))
