...
class ScheduleServiceSpec extends WordSpec with TestBaseDefinition {
  ...
  "A ScheduleService" should {
    ...
    "populate initial schedules any times" in {
      val entries = (0 until 6).map(n => TimetableEntry(Set(User.randomUUID), Room.randomUUID, Degree.randomUUID, Weekday.toDay(n).index, LocalTime.now, LocalTime.now)).toSet
    ...
    "evaluate a given schedule when there are some other schedules" in {
      ...
      val ap1Entries = Set(
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("27/10/2015")).index, ft.parseLocalTime("08:00:00"), ft.parseLocalTime("09:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("27/10/2015")).index, ft.parseLocalTime("09:00:00"), ft.parseLocalTime("10:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("27/10/2015")).index, ft.parseLocalTime("10:00:00"), ft.parseLocalTime("11:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("29/10/2015")).index, ft.parseLocalTime("14:00:00"), ft.parseLocalTime("15:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("29/10/2015")).index, ft.parseLocalTime("14:00:00"), ft.parseLocalTime("15:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("29/10/2015")).index, ft.parseLocalTime("15:00:00"), ft.parseLocalTime("16:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("29/10/2015")).index, ft.parseLocalTime("15:00:00"), ft.parseLocalTime("16:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("29/10/2015")).index, ft.parseLocalTime("16:00:00"), ft.parseLocalTime("17:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("29/10/2015")).index, ft.parseLocalTime("16:00:00"), ft.parseLocalTime("17:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("08:00:00"), ft.parseLocalTime("09:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("08:00:00"), ft.parseLocalTime("09:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("09:00:00"), ft.parseLocalTime("10:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("09:00:00"), ft.parseLocalTime("10:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("10:00:00"), ft.parseLocalTime("11:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("10:00:00"), ft.parseLocalTime("11:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("11:00:00"), ft.parseLocalTime("12:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("11:00:00"), ft.parseLocalTime("12:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("12:00:00"), ft.parseLocalTime("13:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("12:00:00"), ft.parseLocalTime("13:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("13:00:00"), ft.parseLocalTime("14:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("13:00:00"), ft.parseLocalTime("14:00:00"))
      )
      val ma1Entries = Set(
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("26/10/2015")).index, ft.parseLocalTime("08:00:00"), ft.parseLocalTime("11:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("27/10/2015")).index, ft.parseLocalTime("08:00:00"), ft.parseLocalTime("11:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("29/10/2015")).index, ft.parseLocalTime("08:00:00"), ft.parseLocalTime("11:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("29/10/2015")).index, ft.parseLocalTime("11:00:00"), ft.parseLocalTime("14:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("11:00:00"), ft.parseLocalTime("14:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("14:00:00"), ft.parseLocalTime("17:00:00"))
      )
...
//      println(s"conflict value ${result._1.evaluate.value}")
    ...
    "generate a schedule with minimal or no conflicts considering two existing competitive schedules and more density" in {
      ...
      val gdvkEntries = Set(
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("08:00:00"), ft.parseLocalTime("11:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("11:00:00"), ft.parseLocalTime("13:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("30/10/2015")).index, ft.parseLocalTime("14:00:00"), ft.parseLocalTime("17:00:00"))
      )
...
//      println(s"conflict value ${result._1.evaluate.value}")
    ...
    /*"generate a schedules with minimal or no conflicts considering three existing competitive schedules and more density" in {
      ...
      val anotherEntries = Set(
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("26/10/2015")).index, ft.parseLocalTime("11:00:00"), ft.parseLocalTime("13:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("28/10/2015")).index, ft.parseLocalTime("11:00:00"), ft.parseLocalTime("13:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("28/10/2015")).index, ft.parseLocalTime("13:00:00"), ft.parseLocalTime("15:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("29/10/2015")).index, ft.parseLocalTime("11:00:00"), ft.parseLocalTime("13:00:00")),
        TimetableEntry(Set(User.randomUUID), Room.randomUUID, mi.id, Weekday.toDay(fd.parseLocalDate("29/10/2015")).index, ft.parseLocalTime("13:00:00"), ft.parseLocalTime("15:00:00"))
      )
