...
class SemesterCRUDControllerSpec extends AbstractCRUDControllerSpec[Semester] {
  override val entityToPass: Semester = Semester("name to pass", "startDate to pass", "endDate to pass", "examPeriod to pass")
  ...
  override val entityToFail: Semester = Semester("name to fail", "startDate to fail", "endDate to fail", "examPeriod to fail")
  ...
  "A SemesterCRUDController " should {
    "successfully return all semesters for a year" in {
      val semesterWithDate = Semester("name to pass", DateTime.now().toString, "endDate to pass", "examPeriod to pass")
    ...
    "successfully return all semesters for many years" in {
      val semesterIn2015 = Semester("name to pass", DateTime.now().toString, "endDate to pass", "examPeriod to pass")
      val semesterIn2016 = Semester("name to pass", DateTime.now().plusYears(1).toString, "endDate to pass", "examPeriod to pass")
      val semesterIn2017 = Semester("name to pass", DateTime.now().plusYears(2).toString, "endDate to pass", "examPeriod to pass")
      val semesterIn2018 = Semester("name to pass", DateTime.now().plusYears(3).toString, "endDate to pass", "examPeriod to pass")
    ...
    "not return semesters for a year when there is no match" in {
      val semesterWithDate = Semester("name to pass", new DateTime(2014, 1, 1, 1, 1).toString, "endDate to pass", "examPeriod to pass")
      val anotherSemesterWithDate = Semester("name to pass", new DateTime(2013, 1, 1, 1, 1).toString, "endDate to pass", "examPeriod to pass")
    ...
    "successfully return all semesters for a specific period" in {
      val semesterInWS = Semester("name to pass", new DateTime(2015, 10, 1, 1, 1).toString, "endDate to pass", "examPeriod to pass")
      val semesterInSS = Semester("name to pass", new DateTime(2015, 3, 1, 1, 1).toString, "endDate to pass", "examPeriod to pass")
    ...
    "successfully return all semesters in different years for a specific period" in {
      val semesterInWS2015 = Semester("name to pass", new DateTime(2015, 10, 1, 1, 1).toString, "endDate to pass", "examPeriod to pass")
      val semesterInWS2017 = Semester("name to pass", new DateTime(2017, 12, 1, 1, 1).toString, "endDate to pass", "examPeriod to pass")
      val semesterInSS2015 = Semester("name to pass", new DateTime(2015, 3, 1, 1, 1).toString, "endDate to pass", "examPeriod to pass")
      val semesterInSS2018 = Semester("name to pass", new DateTime(2018, 5, 1, 1, 1).toString, "endDate to pass", "examPeriod to pass")
