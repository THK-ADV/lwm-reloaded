...
class UserControllerSpec extends WordSpec with TestBaseDefinition {
  ...
  "A UserController" should {
    ...
    "atomize one specific user, regardless of his subcategory" in {
      ...
      val student1 = Student("ai1818", "Hans", "Wurst", "bla@mail.de", "11223344", degree.id, Student.randomUUID)
      val student2 = Student("mi1818", "Sanh", "Tsruw", "alb@mail.de", "44332211", UUID.randomUUID(), Student.randomUUID)
      val student3 = Student("wi1818", "Nahs", "Rustw", "lab@mail.de", "22331144", UUID.randomUUID(), Student.randomUUID)
      val employee1 = Employee("mlark", "Lars", "Marklar", "mark@mail.de", "status", Employee.randomUUID)
      val employee2 = Employee("mlark", "Sarl", "Ralkram", "kram@mail.de", "status", Employee.randomUUID)
      ...
      val result = controller.getAtomic(Student.generateUri(student1)(ns))(request)
    ...
    "atomize all users, regardless of their subcategory" in {
      ...
      val student1 = Student("ai1818", "Hans", "Wurst", "bla@mail.de", "11223344", degree1.id, Student.randomUUID)
      val student2 = Student("ai2182", "Sanh", "Tsruw", "alb@mail.de", "44332211", degree1.id, Student.randomUUID)
      val student3 = Student("ai3512", "Nahs", "Rustw", "lab@mail.de", "22331144", degree1.id, Student.randomUUID)
      val employee1 = Employee("mlark", "Lars", "Marklar", "mark@mail.de", "status", Employee.randomUUID)
      val employee2 = Employee("mlark", "Sarl", "Ralkram", "kram@mail.de", "status", Employee.randomUUID)
      val employee3 = Employee("rlak", "Rasl", "Kramral", "ramk@mail.de", "status", Employee.randomUUID)
      val users: Set[User] = Set(student1, student2, student3, employee1, employee2, employee3)
    ...
    "atomize a single student" in {
      ...
      val result = controller.studentAtomic(Student.generateUri(student1)(ns))(request)
    ...
    "get students specific to particular degree" in {
      ...
      val student1 = Student("ai1818", "Hans", "Wurst", "bla@mail.de", "11223344", degree1.id, Student.randomUUID)
      val student2 = Student("ai2182", "Sanh", "Tsruw", "alb@mail.de", "44332211", degree1.id, Student.randomUUID)
      val student3 = Student("mi3512", "Nahs", "Rustw", "lab@mail.de", "22331144", Degree.randomUUID, Student.randomUUID)
      val students: Set[Student] = Set(student1, student2, student3)
    ...
    "get atomized students specific to a particular degree" in {
      ...
      val student1 = Student("ai1818", "Hans", "Wurst", "bla@mail.de", "11223344", degree1.id, Student.randomUUID)
      val student2 = Student("ai2182", "Sanh", "Tsruw", "alb@mail.de", "44332211", degree1.id, Student.randomUUID)
      val student3 = Student("mi3512", "Nahs", "Rustw", "lab@mail.de", "22331144", UUID.randomUUID(), Student.randomUUID)
      val students: Set[Student] = Set(student1, student2, student3)
    ...
    "get employees specific to a particular status" in {
      val employee1 = Employee("mlark", "Lars", "Marklar", "mark@mail.de", "lecturer", Employee.randomUUID)
      val employee2 = Employee("mlark", "Sarl", "Ralkram", "kram@mail.de", "employee", Employee.randomUUID)
      val employee3 = Employee("rlak", "Rasl", "Kramral", "ramk@mail.de", "lecturer", Employee.randomUUID)
      val employees: Set[Employee] = Set(employee1, employee2, employee3)
    ...
    "get users specific to some particular filter attribute" in {
      ...
      val student1 = Student("ai1818", "Hans", "Wurst", "bla@mail.de", "11223344", degree, Student.randomUUID)
      val student2 = Student("ai2182", "Sanh", "Tsruw", "alb@mail.de", "44332211", UUID.randomUUID(), Student.randomUUID)
      val student3 = Student("mi3512", "Nahs", "Rustw", "lab@mail.de", "22331144", degree, Student.randomUUID)
      val employee1 = Employee("mlark", "Lars", "Marklar", "mark@mail.de", "lecturer", Employee.randomUUID)
      val employee2 = Employee("mlark", "Sarl", "Ralkram", "kram@mail.de", "employee", Employee.randomUUID)
      val employee3 = Employee("rlak", "Rasl", "Kramral", "ramk@mail.de", "lecturer", Employee.randomUUID)
      val users: Set[User] = Set(student1, student2, student3, employee1, employee2, employee3)
    ...
    "get atomized users specific to some particular filter attribute" in {
      ...
      val student1 = Student("ai1818", "Hans", "Wurst", "bla@mail.de", "11223344", degree1.id, Student.randomUUID)
      val student2 = Student("ai2182", "Sanh", "Tsruw", "alb@mail.de", "44332211", UUID.randomUUID(), Student.randomUUID)
      val student3 = Student("mi3512", "Nahs", "Rustw", "lab@mail.de", "22331144", degree1.id, Student.randomUUID)
      val employee1 = Employee("mlark", "Lars", "Marklar", "mark@mail.de", "lecturer", Employee.randomUUID)
      val employee2 = Employee("mlark", "Sarl", "Ralkram", "kram@mail.de", "employee", Employee.randomUUID)
      val employee3 = Employee("rlak", "Rasl", "Kramral", "ramk@mail.de", "lecturer", Employee.randomUUID)
      val users: Set[User] = Set(student1, student2, student3, employee1, employee2, employee3)
