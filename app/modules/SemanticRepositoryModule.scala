...
trait ConfigurableBaseNamespace extends BaseNamespace {
  ...
  override lazy val namespace: Namespace = Namespace(lwmConfig.underlying.getString("lwm.namespace"))
}
...
trait DefaultSemanticRepositoryModuleImpl extends SemanticRepositoryModule {
  ...
  lazy val repository: SesameRepository = SesameRepository(folder, namespace)
}
