...
case class Course(label: String, abbreviation: String, lecturer: UUID, semesterIndex: Int, id: UUID) extends UniqueEntity

case class CourseProtocol(label: String, abbreviation: String, lecturer: UUID, semesterIndex: Int)
