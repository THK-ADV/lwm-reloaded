...
case class AssignmentEntry(index: Int, types: Set[EntryType], id: UUID = AssignmentEntry.randomUUID) extends UniqueEntity
case class AssignmentEntryProtocol(index: Int, types: Set[EntryType])
