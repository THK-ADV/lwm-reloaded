...
@Singleton
final class GroupControllerPostgres @Inject()(cc: ControllerComponents, val authorityDao: AuthorityDao, val abstractDao: GroupDao, val labworkApplicationDao: LabworkApplicationDao, val securedAction: SecuredAction)
  extends AbstractCRUDControllerPostgres[PostgresGroupProtocol, GroupTable, GroupDb, Group](cc)
