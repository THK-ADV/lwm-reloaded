...
//}
//
//final class CourseControllerPostgres(val abstractDao: CourseDao, val authorityService: AuthorityDao) extends AbstractCRUDControllerPostgres[PostgresCourseProtocol, CourseTable, CourseDb, Course] {
//
