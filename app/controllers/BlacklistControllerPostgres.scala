...
//}
//
//final class BlacklistControllerPostgres(val authorityDao: AuthorityDao, val abstractDao: BlacklistDao, val blacklistService: BlacklistService) extends AbstractCRUDControllerPostgres[PostgresBlacklistProtocol, BlacklistTable, BlacklistDb, PostgresBlacklist] {
//
