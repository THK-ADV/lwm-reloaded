...
@Singleton
final class AuthorityControllerPostgres @Inject() (cc: ControllerComponents, val abstractDao: AuthorityDao, val securedAction: SecuredAction)
  extends AbstractCRUDControllerPostgres[PostgresAuthorityProtocol, AuthorityTable, AuthorityDb, Authority](cc) {
