...
@Singleton
final class ScheduleEntryControllerPostgres @Inject()(
...
) extends AbstractCRUDControllerPostgres[PostgresScheduleEntryProtocol, ScheduleEntryTable, ScheduleEntryDb, ScheduleEntry](cc) with GroupingStrategyAttributeFilter {
