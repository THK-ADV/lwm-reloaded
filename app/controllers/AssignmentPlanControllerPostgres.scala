...
@Singleton
final class AssignmentPlanControllerPostgres @Inject()(cc: ControllerComponents, val authorityDao: AuthorityDao, val abstractDao: AssignmentPlanDao, val securedAction: SecuredAction)
  extends AbstractCRUDControllerPostgres[PostgresAssignmentPlanProtocol, AssignmentPlanTable, AssignmentPlanDb, AssignmentPlan](cc) {
