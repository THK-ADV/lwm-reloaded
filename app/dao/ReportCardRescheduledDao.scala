...
import store.{PostgresDatabase, ReportCardRescheduledTable, TableFilter}
...
//}
//
//final class ReportCardRescheduledImpl(val database: PostgresDatabase) extends ReportCardRescheduledDao
