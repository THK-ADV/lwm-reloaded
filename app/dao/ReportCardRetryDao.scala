...
import store.{PostgresDatabase, ReportCardEntryTypeTable, ReportCardRetryTable, TableFilter}
...
//}
//
//final class ReportCardRetryDaoImpl(val database: PostgresDatabase) extends ReportCardRetryDao