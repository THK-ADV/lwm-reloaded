...
import store.{PostgresDatabase, ReportCardEvaluationPatternTable, TableFilter}
...
//}
//
//final class ReportCardEvaluationPatternDaoImpl(val database: PostgresDatabase) extends ReportCardEvaluationPatternDao