...
import store.{PostgresDatabase, ReportCardEntryTypeTable, TableFilter}
...
//}
//
//final class ReportCardEntryTypeDaoImpl(val database: PostgresDatabase) extends ReportCardEntryTypeDao