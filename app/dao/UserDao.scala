...
//}
//
//final class UserDaoImpl(val database: PostgresDatabase, val authorityService: AuthorityDao, val degreeService: DegreeDao, val labworkApplicationService: LabworkApplicationDao) extends UserDao